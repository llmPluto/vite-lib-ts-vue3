...
import { reactive as l, getCurrentInstance as m, provide as x, isVNode as h, defineComponent as k, openBlock as y, createElementBlock as C, renderSlot as b } from "vue";
function v(s) {
  const e = [], n = (t) => {
...
const A = /* @__PURE__ */ f(g, [["__scopeId", "data-v-3ffb6409"]]), T = _(A);
export {
  T as default
};
